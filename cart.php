							...
							if (!empty($_SESSION['cart'])) {
								...
								foreach ($_SESSION['cart'] as $key => $value) {
									...
									<tr>
										...
										<td><i class="fas fa-rupee-sign" style="margin-right: 5px;"></i><?php $sp = $value['item_price'] - ($value['item_price'] * ($value['discount'] / 100));
																																										echo number_format($sp); ?></td>
								...
								<tr>
									...
									<td colspan="5">
										<h5><i class="fa fa-rupee-sign" style="margin-right: 5px;"></i><?php echo number_format($total, 2); ?></h5>
									</td>
								</tr>
						...
						<table class="table">
							...
							<tr>
								...
								<td class="right" style="font-size: 15px;">
									<p><i class="fa fa-rupee-sign" style="margin-right: 5px;"></i><?php echo number_format($total, 2); ?></p>
								</td>
							</tr>
							<tr>
