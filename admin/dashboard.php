		...
		<div class="col s12 m6 l3">
			<div class="card gradient-1 z-depth-1 hoverable center-align">
				<div class="card-content white-text">
					...
					<?php $sql = "SELECT COUNT(`item_id`) FROM item";
					$result = mysqli_query($conn, $sql);
					while ($row = mysqli_fetch_array($result)) { ?>
		...
		<div class="col s12 m6 l3">
			<div class="card gradient-2 hoverable z-depth-1 center-align">
				<div class="card-content white-text">
					...
					<?php $sql = "SELECT COUNT(`cat_id`) FROM category";
					$result = mysqli_query($conn, $sql);
					while ($row = mysqli_fetch_array($result)) { ?>
		...
		<div class="col s12 m6 l3">
			<div class="card z-depth-1 hoverable gradient-5 center-align">
				<div class="card-content white-text">
					...
					<?php $sql = "SELECT COUNT(`order_details_id`) FROM order_details";
					$result = mysqli_query($conn, $sql);
					while ($row = mysqli_fetch_array($result)) { ?>
	...
	<div class="row">
		<div class="col s12 m12 l6 xl6">
			<div class="card-panel">
				<div class="card-title center" style="font-size: 18px;">New Messages <i class="fa fa-envelope"></i></div>
				<hr>
				<div class="card-content">
					<table class="table striped highlight animated fadeIn">
						...
						<tbody>
							...
							if ($checkRecord < 1) {
								echo '<tr><td colspan="3">Your Inbox is empty!</td></tr>';
							} else {
									while ($row = mysqli_fetch_array($result)) { ?>
