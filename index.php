...
<div class="container-fluid animated fadeIn" style="margin-top: 16px;">
	<div class="row">
		...
		<div class="col m3 l3">
			...
			<div class="card">
			<?php $sql = "SELECT * FROM item ORDER BY RAND(`item_id`) ASC LIMIT 1;"; $result = mysqli_query($conn, $sql); while ($row = mysqli_fetch_array($result)) { ?>	
        ...
        <div class="card-content">
          ...
          <p class="truncate"><?php echo $row[5]; ?></p>
					<a href="product.php?pid=<?php echo $row[0]; ?>">See more</a>
        </div>
      </div>
		<?php }?>
		</div>
